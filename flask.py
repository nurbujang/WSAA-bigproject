...
# You should also create the web pages that can consume the API. 
# I.e. performs CRUD operations on the data.

# Description:
# A rehash of the sample project lab 
# i.e. A basic Flask server that has a:
...
#     • Save the data into a database table that you view elsewhere in your application.
